...
# Definimos las fechas de inicio y fin según la solicitud.
fecha_inicio="20250401"
fecha_fin="20250428"

# Bucle para iterar sobre el rango de fechas
for current_date in $(seq -f "%08g" $fecha_inicio $fecha_fin); do
    echo "Ejecutando cargar_i11.sh $current_date"
    ./cargar_i11.sh "$current_date"
